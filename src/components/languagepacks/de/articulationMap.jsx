const articulationMap = {
  ...
  frames: [
    ...
    { index: 1,  label: 'a_u',               phonemes: ['a', 'ai', 'u'] },
    { index: 2,  label: 'e',                 phonemes: ['e'] },
    { index: 3,  label: 'ee',                phonemes: ['i', 'ee'] },
    { index: 4,  label: 'ue',                phonemes: ['oe', 'ue'] },
    { index: 5,  label: 'oo_o_ou_w',         phonemes: ['o', 'u', 'w'] },
    { index: 6,  label: 'c_k_q_kh_g',        phonemes: ['k', 'g', 'kh'] },
    { index: 7,  label: 't_tsk_d_j',         phonemes: ['t', 'd'] },
    { index: 8,  label: 'b_p_m',             phonemes: ['b', 'p', 'm'] },
    { index: 9,  label: 'n',                 phonemes: ['n'] },
    { index: 10, label: 'ng',                phonemes: [] },
    { index: 11, label: 's_z_x',             phonemes: ['s', 'z'] },
    { index: 12, label: 'sh',                phonemes: ['sh', 'ch'] },
    { index: 13, label: 'th',                phonemes: [] },
    { index: 14, label: 'f_v',               phonemes: ['f', 'v'] },
    { index: 15, label: 'ch',                phonemes: ['ts', 'pf'] },
    { index: 16, label: 'h',                 phonemes: ['h'] },
