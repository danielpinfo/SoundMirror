const PACK_PLAYBACK_RATE = 0.4;

export class GoogleTTSProvider {
  constructor(phonemeResolver = null, options = {}) {
    this.name = 'GoogleTTSProvider';
    this.locale = options.locale ?? 'hi-IN';
    this.ready = true;
    this._phonemeResolver = phonemeResolver;
    this.voice = options.voice ?? 'hi-IN-Neural2-A';
    this.speechRate = options.speechRate ?? PACK_PLAYBACK_RATE;
